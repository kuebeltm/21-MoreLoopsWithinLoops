...
def triangle_upside_down(r):
    ...
    # ------------------------------------------------------------------
    for inc in range(r):
        for space in range(inc):
            print(' ', end='')
        for num in range(r-inc):
            print(num+1, end='')
        print('')
...
def vee(r):
    ...
    for inc in range(r):
        ...
        for num in range(r-inc):
            print(num+1, end='')
        print('-', end='')
        for back in range(r-inc):
            print(num-back+1, end='')
        print()
